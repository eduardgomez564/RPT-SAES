...
// Tabs
import ProponentTab from "./Tabs/ProponentTab";
import TeacherTab from "./Tabs/TeacherTab";
import AttendanceTab from "./Tabs/AttendanceTab";

export default function Students() {
  const [activeTab, setActiveTab] = useState("as Proponent");
          ...
          >
            ...
            >
              ...
              >
                ...
                "
                >
                  {["as Proponent", "as Teacher", "Attendance"].map((tab) => (
                    <button
                      key={tab}
              ...
              "
              >
                {activeTab === "as Proponent" && <ProponentTab />}
                {activeTab === "as Teacher" && <TeacherTab />}
